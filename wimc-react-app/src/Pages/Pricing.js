...
const MONTHLY_PLANS = [
  {
    ...
    features: [
      ...
      { text: "Upload photos to your wardrobe", check: true },
      { text: "Basic outfit preview", check: true },
      { text: "Weather-based outfit suggestions", check: true },
      { text: "AI Stylist & Donation Advisor", check: false },
      { text: "Kids' Closet", check: false },
      { text: "Travel Pack Planner", check: false },
      { text: "Wish List & Shopping List", check: false },
      { text: "Video Bin", check: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Kids' Closet", check: true },
      { text: "Travel Pack Planner", check: true },
      { text: "Wish List & Shopping List", check: true },
      { text: "Donate Bin & history", check: true },
      { text: "Video Bin", check: true },
      { text: "Unlimited uploads", check: true },
      { text: "Outfit of the Day planner", check: true },
      { text: "AI Stylist & Donation Advisor", check: false },
      { text: "AI Packing Assistant", check: false },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: "AI Stylist (unlimited chats)", check: true },
      { text: "AI Donation Advisor", check: true },
      { text: "AI Packing Assistant", check: true },
