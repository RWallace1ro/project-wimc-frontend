...
const SLIDES = [
  ...
  },
  {
    ...
    features: ["Live camera recording","Front / rear camera toggle","Upload & cloud storage","AI Style Feedback (4 sections)","Video Bin with grid / list","Timestamps & custom titles","Download & share videos"],
    featureIcons: ["📸","🔄","☁️","✨","🎥","🕐","⬇️"],
  },
  {
    id: "donate-wishlist",
