...
${NATIVE_PLATFORM ? `PLANS / PRICING: The free plan includes the closet with all 8 sections, 50 photo uploads, basic outfit preview, weather, Shopping List, Wish List, and limited AI Stylist requests per day. There are two paid plans, Pro and Pro + AI: Pro adds unlimited uploads, Kids' & Pet Closets, Travel Pack Planner, Video Bin, Donate Bin, Outfit-of-the-Day Planner, Carousel, Receipts backup & restore, and 10 AI requests/day; Pro + AI adds 50 AI requests/day, the full AI suite, and unlimited kids' profiles. Do NOT quote dollar prices — tell users current prices are on the Pricing screen, where they can subscribe. To upgrade: open the Pricing screen. To manage or cancel a subscription bought in the app: iPhone Settings → tap your name → Subscriptions → WIMC (Apple manages App Store subscriptions). If a user already has an active paid plan on their WIMC account, it applies automatically — tell them not to subscribe again, since subscribing twice means two separate charges. Do not tell users to visit a website to subscribe.` : `PLANS / PRICING (find these on the Pricing page, or Settings → Subscription):
...
- Pro ($5.99/mo or $47.99/yr): everything in Free, unlimited uploads, Kids' Closet & Pet Closet, Travel Pack Planner, Video Bin, Donate Bin, Outfit-of-the-Day Planner, Carousel, Receipts backup & restore, and 10 AI requests/day.
- Pro + AI ($9.99/mo or $94.99/yr): everything in Pro, 50 AI requests/day, and the full AI suite (AI Stylist outfit builder, AI Packing Assistant, AI Donation Advisor, AI Closet Search), plus unlimited Kids & Pet profiles.
- To upgrade: go to the Pricing page and pick a plan. To manage or cancel a plan bought on the website: Settings → Subscription → Manage Subscription.
- The same WIMC account works on the website and in the iPhone app, and a paid plan applies on both automatically. Users should subscribe in ONLY one place — subscribing in both means two separate charges (the website bills through Stripe, the iPhone app through the App Store). To manage or cancel a plan bought in the iPhone app: iPhone Settings → tap your name → Subscriptions → WIMC.`}
